...
# Remove everything from <div className="relative z-10 max-w-2xl"> to the end of the duplicate <p> tag and </div>
content = re.sub(r'<div className="relative z-10 max-w-2xl">.*?</p>\s*</div>\s*<h1.*?</p>\s*</div>', replacement, content, flags=re.DOTALL)
