...
<div id="estarr-badge" data-theme="${themeStr}" data-type="${typeStr}" style="width: ${sizeStr}; display: inline-block;">
  <a href="https://estarr.com/verify/${userProfile?.email ? encodeURIComponent(userProfile.email) : "expert"}" target="_blank" rel="noopener noreferrer">
...
const estarr = axios.create({
  baseURL: 'https://api.estarr.com/v1',
  headers: {
...
url = "https://api.estarr.com/v1/talent/list"
...
if response.status_code == 200:
    ...
    curl: `curl -X GET "https://api.estarr.com/v1/talent/list?role=${encodeURIComponent(sandboxVariables.role)}&limit=${sandboxVariables.limit}&vettedOnly=true" \\
...
func main() {
	baseURL := "https://api.estarr.com/v1/talent/list"
	params := url.Values{}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4 flex flex-col gap-4">
                  ...
                  <div className="border border-slate-200 rounded-xl p-4 flex flex-col gap-2 bg-slate-50/30">
                    ...
                    <a href="https://docs.estarr.com" target="_blank" rel="noreferrer" className="flex items-center justify-between p-2 hover:bg-slate-50 text-slate-800 font-medium text-xs rounded border border-slate-200 cursor-pointer">
