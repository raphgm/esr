...
export function ServicesCarousel({ onSelect, isAuthenticated, onAuthRequest }: ServicesCarouselProps) {
  ...
  const partnerBrands = [
    ...
    },
    {
      ...
      desc: "Powering deep language agents (GPT-4) to dynamically draft agreements, audit service codes, and match talents instantly.",
      metric: "GPT-4o Native LLM",
      badge: "LLM Orchestration",
      status: "Active Link",
      latency: "28ms",
      themeColor: "green",
      color: "bg-green-50/50 text-green-600 border-green-100 group-hover:bg-green-600 group-hover:text-white",
      logoSvg: (
        <div className="flex items-center justify-center shrink-0 px-1">
