...
export const initialJobs: Job[] = [
  {
    ...
    description: "We are looking for detail-oriented specialists for Reinforcement Learning from Human Feedback (RLHF). You will evaluate AI model outputs for cultural nuance and accuracy.",
    skillsRequired: ["Data Labeling", "RLHF", "Cultural Linguistics"],
    matchScore: 92
  },
  {
    id: "job-2",
    ...
    description: "Build API connectors and deploy LLM agents to automate our logistics dispatch routing and customer service inquiries.",
    skillsRequired: ["Python", "LangChain", "OpenAI API", "System Architecture"],
    matchScore: 60
  },
  {
    id: "job-3",
    title: "Freelance Prompt Engineer",
    company: "Kala Bespoke AI",
    type: "Independent",
    location: "Surulere, Lagos",
    salary: "₦15,000 / Prompt Template",
    description: "We need expert prompt engineers to design zero-shot and few-shot templates for our personalized AI fashion recommendation engine.",
    skillsRequired: ["Prompt Engineering", "LLM Testing", "Creative Writing"],
    matchScore: 40
  },
  {
    id: "job-4",
    title: "Junior AI Model Trainer",
    company: "Lagos Tech Hub",
    type: "Apprenticeship",
    location: "Remote",
    salary: "₦200k - ₦350k/mo",
    description: "Perfect for recently trained AI enthusiasts. Help our ML team curate datasets, run evaluation scripts, and categorize training data. Mentorship provided.",
    skillsRequired: ["Python Basics", "Data Curation", "Jupyter Notebooks"],
    matchScore: 85
  },
  {
    id: "job-5",
    title: "Trainee AI Content Editor",
    company: "ChopLife Restaurants",
    type: "Apprenticeship",
    location: "Remote",
    salary: "₦150k/mo + Meals",
    description: "Looking for an AI content editor who has completed the 'Generative AI' academy course. You will use AI tools to generate and edit weekly marketing copy.",
    skillsRequired: ["ChatGPT", "Midjourney", "AI Copywriting"],
    matchScore: 78
  }
];
